------------------------------BREVE INTRODUCCION DEL PROYECTO------------------------------

Se creo un eCommerce con React JS de una tienda de videojuegos y consolas: "TU CASA GAMER". La misma fue maquetada con libreria de Material UI y CSS puro (ya que algunos componentes de MUI facilitaron mucho el maquetado y estilado de la app). Para el mensaje final de compra se añadió sweetalert para confirmar la orden.
